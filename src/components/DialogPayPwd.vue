    ...
    <div v-transfer-dom>
      <popup v-model="showPopup">
        <div class="popupBox">
          ...
          <p class="num_name_box fs22 textCenter"><span>互联网小贷安全键盘</span> </p>
          <div class="form_edit">
...
<script>
  ...
  export default {
    ...
    methods: {
      findPayPwd(){//找回密码链接
        this.$router.push({path: '/indentifyingCode'})
      },
      ColsePopupg(){//关闭弹窗
...
<style lang="less" scoped>
  ...
  .num_name_box span{ line-height: 10px; background: url("../assets/images/zf_ico.png") left center no-repeat; background-size: 0.30rem 0.33rem;padding: 5px 0 5px 0.35rem; }
  ...
  .form_edit> div:last-child {  background-image:url("../assets/images/del_ico.jpg");  background-repeat: no-repeat;  background-position: center center;  background-size: 0.56rem 0.38rem;  }
</style>
